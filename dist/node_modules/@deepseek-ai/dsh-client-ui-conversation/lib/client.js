window.__ModuleLoader__.load({
 ...
 /* v8 ignore next 4 -- plain-text composition nests no block elements today; the walk stays total for imported states. */
		...
		*/
		...
		const heroModeClusterCss = ".wSkVaW_heroWorkspaceRow [data-slot=conversation\\.hero\\.agentPreset]>span{width:max-content!important;min-width:0!important;max-width:240px;flex:none}.wSkVaW_heroModeCluster{width:max-content;max-width:100%;flex:none;align-items:center;gap:2px;display:flex}.wSkVaW_heroModeCluster button{box-sizing:border-box;height:28px;padding:0 8px!important;border:0!important;border-radius:8px!important;background:transparent!important;color:var(--dsw-alias-label-primary)!important;font:inherit;font-size:13px;font-weight:500;line-height:20px;gap:6px;cursor:pointer;transition:background-color .12s ease,color .12s ease,transform .12s ease}.wSkVaW_heroModeCluster button:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover)!important;color:var(--dsw-alias-label-primary)!important}.wSkVaW_heroModeCluster button[data-selected=true]{background:color-mix(in srgb,var(--dsw-alias-state-business-primary) 10%,transparent)!important;color:var(--dsw-alias-state-business-primary)!important}.wSkVaW_heroModeCluster button:active:not(:disabled){transform:scale(.98)}.wSkVaW_heroModeCluster button:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:2px}.wSkVaW_heroWorkspaceRow{padding-right:20px;box-sizing:border-box}";
		const tagId$4 = "@deepseek-ai/dsh-client-ui-conversation/ConversationRoot.module.css";
		if (typeof document !== "undefined" && document.querySelector("style[data-plugin-css=" + JSON.stringify(tagId$4) + "]") === null) {
			const tag = document.createElement("style");
			tag.dataset.plugin = "@deepseek-ai/dsh-client-ui-conversation";
			tag.dataset.pluginCss = tagId$4;
			tag.textContent = css$4 + heroModeClusterCss;
			document.head.appendChild(tag);
		}
		var ConversationRoot_module_css_default = {
			...
			"heroModeCluster": "wSkVaW_heroModeCluster",
		...
		function ConversationRoot({ sessionId, useSession, useSessions, useSessionPendingInteraction, useWorkspaces, useConversation, useInput, useComposerBlock, renderSlot, renderSlotChain, selectWorkspace, t }) {
			...
			const heroWorkspaceRow = (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					(0, react_jsx_runtime.jsx)("div", {
						className: ConversationRoot_module_css_default.heroModeCluster,
						children: zone !== void 0 && renderSlot("conversation.hero.modeActions", zone)
					})
				]
			});
		...
		*/
		...
		const pptAccessoryCss = ".uV2eYG_promptRow{display:contents}.uV2eYG_promptRow:has(.uV2eYG_accessory [data-slot=conversation\\.input\\.accessory]:not(:empty)){align-items:flex-start;gap:12px;min-width:0;display:flex}.uV2eYG_accessory{align-items:flex-start;flex:0 0 auto;min-width:0;padding-left:16px;display:none}.uV2eYG_accessory:has([data-slot=conversation\\.input\\.accessory]:not(:empty)){display:flex}.uV2eYG_promptRow:has(.uV2eYG_accessory [data-slot=conversation\\.input\\.accessory]:not(:empty))>.uV2eYG_scroll{flex:1 1 auto;min-width:0}.uV2eYG_promptRow:has(.uV2eYG_accessory [data-slot=conversation\\.input\\.accessory]:not(:empty))>.uV2eYG_scroll .uV2eYG_input{padding-left:0}.uV2eYG_promptRow:has(.uV2eYG_accessory [data-slot=conversation\\.input\\.accessory]:not(:empty))>.uV2eYG_scroll .uV2eYG_placeholder{left:0}";
		...
		*/
		const InputBar = (0, react.memo)(function InputBar({ useSession, useInput, inputActions, keyboard, addFiles, removeAttachment, resolveDraftAttachments, retryFileUpload, toggleCommandMenu, stop, command, t, renderSlot, useBusyEnter, useFileUploads, useNotices, useLexicon, useMenuLauncher, useProjection, sessionId, variant, disabled: inert = false, blocked, workspacePickerOpen = false, onRequestWorkspace, placeholder, accessory, extensionZone }) {
				...
				children: [
					...
					(0, react_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							(0, react_jsx_runtime.jsxs)("div", {
								className: InputBar_module_css_default.promptRow,
								"data-input-prompt-row": true,
								children: [(accessory !== void 0 || extensionZone !== void 0) && (0, react_jsx_runtime.jsx)("div", {
