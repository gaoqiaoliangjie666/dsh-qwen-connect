window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		function AgentPresetSeat({ load, select, introduced, useAgentPresetSeat, t }) {
			...
			return (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [(0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Menu, {
				...
				portal: true,
				compact: true,
				className: `${AgentPresetSeat_module_css_default.menuAnchor} ${AgentPresetSeat_module_css_default.picker}`,
		...
		*/
		...
		/** Stringify a thrown value for a status field. */
		...
		const sectionDesktopCss = ".dshPreset_sectionHead{align-items:center;gap:16px;display:flex}.dshPreset_sectionActions{flex:none;align-items:center;justify-content:flex-end;gap:8px;margin-left:auto;display:flex}.dshPreset_importButton{flex:none}.dshPreset_hiddenInput{display:none}.dshPreset_importSecurity{color:var(--dsw-alias-label-secondary);background:var(--dsw-alias-interactive-bg-hover);border-radius:8px;margin:0;padding:8px 10px;font-size:12px;line-height:1.5}.dshPreset_importSummary{grid-template-columns:max-content minmax(0,1fr);column-gap:12px;row-gap:4px;margin:0;font-size:12px;display:grid}.dshPreset_importSummary dt{color:var(--dsw-alias-label-tertiary)}.dshPreset_importSummary dd{margin:0;overflow-wrap:anywhere}.dshPreset_importWarnings{color:var(--dsw-alias-state-warning-primary,var(--dsw-alias-label-secondary));margin:0;padding-left:20px;font-size:12px;line-height:1.5}";
		const tagId = "@deepseek-ai/dsh-client-ui-agent-preset/AgentPresetSection.module.css";
		if (typeof document !== "undefined" && document.querySelector("style[data-plugin-css=" + JSON.stringify(tagId) + "]") === null) {
			const tag = document.createElement("style");
			tag.dataset.plugin = "@deepseek-ai/dsh-client-ui-agent-preset";
			tag.dataset.pluginCss = tagId;
			tag.textContent = css + sectionDesktopCss;
			document.head.appendChild(tag);
		}
		var AgentPresetSection_module_css_default = {
			"sectionHead": "dshPreset_sectionHead",
			"sectionActions": "dshPreset_sectionActions",
			"importButton": "dshPreset_importButton",
			"hiddenInput": "dshPreset_hiddenInput",
			"importSecurity": "dshPreset_importSecurity",
			"importSummary": "dshPreset_importSummary",
			"importWarnings": "dshPreset_importWarnings",
